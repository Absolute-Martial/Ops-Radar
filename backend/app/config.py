...
class Settings(BaseSettings):
    ...
    SMTP_USER: str = ""
    SMTP_PASS: str = ""
    SMTP_FROM: str = "alerts@opsradar.local"

    # Ops runtime integrations
    TEMPORAL_ADDRESS: str = ""
    TEMPORAL_SERVER_URL: str = ""
    TEMPORAL_NAMESPACE: str = "default"
    TEMPORAL_TASK_QUEUE: str = "opsradar-requests"
    TEMPORAL_APPROVAL_TIMEOUT_SECONDS: int = 172800
    TEMPORAL_REQUESTER_INFO_TIMEOUT_SECONDS: int = 86400
    OPSRADAR_POLICY_ENGINE: str = "casbin"
    OPSRADAR_POLICY_VERSION: str = "opsradar-v1"
    NOVU_API_URL: str = "https://api.novu.co"
    NOVU_API_KEY: str = ""
    NOVU_WORKFLOW_PREFIX: str = "opsradar"
    OPSRADAR_BASE_URL: str = "http://localhost:3000"
    OPSRADAR_SLACK_SIGNING_SECRET: str = ""
    OPSRADAR_SLACK_BOT_TOKEN: str = ""
    OPSRADAR_SLACK_WORKSPACE_ID: str = ""
    ...
    DEMO_USER_EMAIL: str = "demo@demo.opsradar.local"
    ...
    def validate_production_secrets(self) -> None:
        ...
        msg = (
            ...
            "Set them to real values before starting OpsRadar."
        )
