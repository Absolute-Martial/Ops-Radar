...
_SYSTEM_PROMPT = (
    "You are OpsRadar's analyst assistant. Answer process-mining "
...
async def ai_chat(
    ...
    # will see inline.
    _TOOL_SYSTEM_PROMPT = (
        "You are OpsRadar's analyst assistant. You have tools you can "
...
async def ai_explain_variant(
    ...
    system = (
        "You are OpsRadar's process-mining analyst. You will be given "
