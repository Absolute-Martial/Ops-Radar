    ...
    builtin_templates = [
        {
            "name": "Access Request",
            "category": "opsradar",
            "description": "Controlled intake workflow for software or system access with manager and optional security approval.",
            "expected_activities": [
                "Request Submitted",
                "Policy Checked",
                "Manager Approval",
            ...
            "anti_patterns": [
                {
                    ...
                    "activity": "Security Approval",
                    "description": "High-risk access executed without security review",
                },
                {
                    "name": "Approval wait loop",
                    "pattern": "repeated_activity",
                    "description": "Request bounces between approvers or waits beyond SLA",
                },
            ],
        },
        {
            ...
            "category": "opsradar",
            "description": "Self-service workflow for provisioning a new Jira project with manager and Jira admin approvals.",
            "expected_activities": [
                "Request Submitted",
                "Manager Approval",
                "Jira Admin Approval",
            ...
            "anti_patterns": [
                {
                    ...
                    "description": "Project creation begins before a business owner approves it",
                }
            ],
        },
        {
            "name": "Vendor Review",
            "category": "opsradar",
            "description": "Cross-functional intake for vendor assessments involving security, legal, and finance stakeholders.",
            "expected_activities": [
                "Request Submitted",
                "Business Review",
                "Security Review",
            ...
            "anti_patterns": [
                {
                    "name": "Unowned review",
                    "pattern": "repeated_activity",
                    "description": "Vendor review stalls without a clear next approver",
                }
            ],
        },
        {
