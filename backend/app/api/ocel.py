...
# Unified improvement page: OCEL structural findings + flattened-per-
# object-type findings + cross-object patterns, all on one response.
# ---------------------------------------------------------------------------
...
_NARRATE_SYSTEM_PROMPT_FALLBACK = (
    "You are OpsRadar's process-mining analyst. Given a structured "
...
_EXPLAIN_SYSTEM_PROMPT = (
    "You are OpsRadar's process-mining analyst. You will be given one "
...
<title>OpsRadar OCPM Report — {log_name}</title>
<style>
...
<p class="meta">
  ...
  <strong>Generated by:</strong> OpsRadar
</p>
...
<footer>
  Generated by <strong>OpsRadar</strong> &mdash; Open-source internal operations platform &mdash; {report_date}
</footer>
</body>
</html>"""
