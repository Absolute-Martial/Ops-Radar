...
async def conformance_pdf(
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=20 * mm,
        bottomMargin=20 * mm,
        title=f"OpsRadar Conformance Report — {event_log.name}",
        author="OpsRadar",
    )
    ...
    story.append(Paragraph("OpsRadar Conformance Report", h1))
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph(
            f"This report was generated by OpsRadar using the "
...
<title>OpsRadar Report — {log_name}</title>
<style>
...
<footer>Generated by <strong>OpsRadar</strong> &mdash; Open-source internal operations platform &mdash; {report_date}</footer>
</body>
</html>"""
