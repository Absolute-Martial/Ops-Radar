...
async def export_workflow(
    ...
    if target == "airflow":
        ...
        code = (
            ...
            f"{defs}\n\n"
            "with DAG('opsradar_happy_path', start_date=datetime(2026,1,1), schedule=None, catchup=False) as dag:\n"
            f"    {tasks}\n"
            f"    {chain}\n"
        )
        return {"target": target, "code": code, "language": "python"}
    ...
    n8n_json = {"name": "OpsRadar happy path", "nodes": nodes, "connections": connections}
