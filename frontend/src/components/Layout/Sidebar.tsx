...
const navSections: NavSection[] = [
  {
    label: 'OpsRadar',
    items: [
      { label: 'Workspaces', path: '/projects', icon: FolderKanban },
      { label: 'Radar', path: '/overview', icon: Home },
      { label: 'Request Catalog', path: '/catalog', icon: BookOpen },
  ...
  },
  {
    label: 'Analysis',
    items: [
      { label: 'Friction Dashboards', path: '/dashboards', icon: LayoutDashboard },
      { label: 'Workflow Benchmarks', path: '/benchmark', icon: BarChart3 },
      { label: 'Automation Initiatives', path: '/initiatives', icon: Target },
    ],
  },
  {
    label: 'Configure',
    items: [
      { label: 'Intake Sources', path: '/connectors', icon: Plug },
      { label: 'Workflow Templates', path: '/templates', icon: BookTemplate },
      { label: 'Role Builder', path: '/admin/roles', icon: Shield },
