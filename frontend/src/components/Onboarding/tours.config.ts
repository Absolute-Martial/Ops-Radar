...
export const TOURS: Tour[] = [
  {
    ...
    steps: [
      {
        selector: 'aside nav',
        title: 'Welcome to OpsRadar',
        body: 'Explore workspaces, radar dashboards, alerts, intake sources, and analysis tools from this sidebar. Press "/" to search anywhere or "?" to see shortcuts.',
      },
      {
        selector: 'aside nav a[href="/projects"]',
        title: 'Workspaces hold your workflow traces',
        body: 'Each workspace groups related workflow traces. Create one, upload a trace, and OpsRadar will auto-detect the request ID / step / timestamp columns with a confidence score.',
      },
      {
        selector: 'aside nav a[href="/overview"]',
        title: 'Radar is your starting point',
        body: 'One click away from workflow friction summaries, approval work, and AI-written operational briefings.',
      },
      {
