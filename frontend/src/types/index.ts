...
export interface OpsRadarRoleBlueprint {
  id: string;
  name: string;
  description: string;
...
export interface OpRequestEvent {
  id: string;
  request_id: string;
  event_type: string;
...
export interface OpApprovalInboxItem extends OpApproval {
  request_title: string;
  request_type: string;
  request_status: OpRequestStatus;
  requester_email: string;
  resource_name: string | null;
  access_level: string | null;
  urgency: string;
...
export interface OpRoleAssignment {
  id: string;
  workspace_id: string;
  user_id: string;
  user_email: string;
...
export interface OpIntakeSource {
  id: string;
  workspace_id: string;
  name: string;
  source_type: string;
...
export interface OpIntakeEvent {
  id: string;
  workspace_id: string;
...
export interface OpFulfillmentTask {
  id: string;
  request_id: string;
...
export interface OpPolicyResult {
  id: string;
  request_id: string;
  engine: string;
  decision: string;
...
export interface OpFrictionTemplateMetric {
  request_type: string;
  volume: number;
  median_approval_wait_hours: number | null;
  stuck_count: number;
  rejection_rate: number;
  approver_role_causing_delay: string | null;
  recommended_fix: string;
}

export interface OpFrictionMetrics {
  total_requests: number;
  median_time_to_approval_hours: number | null;
  median_time_to_fulfillment_hours: number | null;
  stuck_requests: number;
  overdue_approvals: number;
  handoff_count: number;
  rejection_rate: number;
  estimated_hours_wasted: number;
  top_slowest_templates: OpFrictionTemplateMetric[];
}
