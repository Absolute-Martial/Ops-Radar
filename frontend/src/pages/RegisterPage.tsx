      ...
      <div className="hidden w-1/2 flex-col justify-between border-r border-line/60 p-12 lg:flex">
        ...
        <div className="max-w-sm">
          <h1 className="text-3xl font-bold leading-tight tracking-tight text-fg">
            Start fixing workflow friction today.
          </h1>
          <p className="mt-4 text-[15px] leading-relaxed text-fg-muted">
            Create an account and start tracing request delays, approval paths,
            and automation opportunities across your internal workflows.
          </p>

          <div className="mt-8 space-y-3">
            {[
              'Load workflow traces from files or approved sources',
              'See friction maps, delay points, and request paths',
              'Track approvals, audits, and policy-driven execution',
              'Create dashboards, alerts, and automation initiatives',
            ].map((feature) => (
        ...
        <p className="text-[12px] text-fg-ghost">
          Controlled intake for modern internal operations.
        </p>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1 text-[13px] text-fg-muted">
            Get started with OpsRadar in seconds
          </p>
