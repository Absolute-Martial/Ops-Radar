      ...
      <div className="hidden w-1/2 flex-col justify-between border-r border-line/60 p-12 lg:flex">
        ...
        <div className="max-w-sm">
          <h1 className="text-[2rem] font-bold leading-tight tracking-tight text-fg">
            Find workflow friction and fix it with reliable approvals.
          </h1>
          <p className="mt-4 text-[14px] leading-relaxed text-fg-muted">
            OpsRadar turns approved intake signals into workflow traces, shows
            where requests get delayed, and gives teams a durable path from
            analysis to approvals and execution.
          </p>
        </div>

        <p className="text-[12px] text-fg-ghost">
          Controlled intake, clear ownership, durable workflows.
        </p>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1 text-[13px] text-fg-muted">
            Sign in to continue to your workflow operations workspace
          </p>
