...
const RequestCatalogPage = lazy(() => import('@/pages/RequestCatalogPage'));
...
export default function App() {
  ...
  // this, a fresh visitor to the demo host would see a flash of
  ...
  if (!bootstrapChecked) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-surface-0">
        <LoadingSpinner size="lg" text="Loading OpsRadar..." />
      </div>
    );
  }
    ...
    <Suspense fallback={LazyFallback}>
      <Routes>
        ...
        >
          ...
          <Route path="/catalog" element={<RequestCatalogPage />} />
          ...
          <Route path="/admin/roles" element={<RoleBuilderPage />} />
